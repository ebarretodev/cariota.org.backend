...
module.exports = {
    info: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, username, email, address, typeNPC, me;
        return __generator(this, function (_b) {
            _a = req.user, username = _a.username, email = _a.email, address = _a.address, typeNPC = _a.typeNPC;
            me = {
                username: username,
                email: email,
                address: address,
    ...
    editAction: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var updates, hasUser;
